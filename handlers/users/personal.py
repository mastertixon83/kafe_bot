...
async def waiter(message: Message, state: FSMContext):
    ...
    if message.text == '👦 Официант':
        ...
        text = f'Введите номер столика и комментарий для официанта, если Вам что-нибудь нужно.\n\n{"‼️" * 5}\n' \
        ...
        text = f'Введите номер столика и комментарий для кальянного мастера, если Вам что-нибудь нужно.\n\n{"‼️" * 5}\n'\
